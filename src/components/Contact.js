  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "mmurthy7702@gmail.com",
      link: "mailto:mmurthy7702@gmail.com",
    ...
    },
    {
      ...
      title: "Phone",
      value: "+91 7702327702",
      link: "tel:+917702327702",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: MapPin,
      title: "Location",
      value: "Tarimela, Anantapur, India 515611",
      link: "#",
            ...
            <div className="space-y-4">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-4 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 cursor-pointer group"
                >
                  <div className={`p-4 bg-gradient-to-r ${info.color} rounded-lg group-hover:scale-110 transition-transform duration-300`}>
